...
public class TestAstarPathFinder {
    ...
    public void testHardGrid() {
        ...
        final AstarPathFinder<GridNode, BidirectedEdge<GridNode>> pathFinder = new AstarPathFinder<>(hardGrid, new DistanceHeuristic());
    ...
    public void testInfinityGrid() {
        ...
        final AstarPathFinder<GridNode, BidirectedEdge<GridNode>> pathFinder = new AstarPathFinder<>(infinityGrid, new DistanceHeuristic());
