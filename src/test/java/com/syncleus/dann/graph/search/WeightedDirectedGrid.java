...
public class WeightedDirectedGrid extends AbstractBidirectedAdjacencyGraph<GridNode, WeightedDirectedEdge<GridNode>> {
    ...
    private final Set<WeightedDirectedEdge<GridNode>> edges = new HashSet<>();
    private final Map<GridNode, Set<WeightedDirectedEdge<GridNode>>> outNeighborEdges = new HashMap<>();
    private final Map<GridNode, Set<GridNode>> outNeighborNodes = new HashMap<>();
    private final Map<GridNode, Set<WeightedDirectedEdge<GridNode>>> inNeighborEdges = new HashMap<>();
    ...
    public WeightedDirectedGrid(final double[][] nodeWeights) {
        ...
        for (int y = 0; y < nodeWeights.length; y++)
            for (int x = 0; x < nodeWeights[0].length; x++) {
                ...
                this.inNeighborEdges.put(this.nodes[y][x], new HashSet<>());
                this.inNeighborNodes.put(this.nodes[y][x], new HashSet<>());
                this.outNeighborEdges.put(this.nodes[y][x], new HashSet<>());
                this.outNeighborNodes.put(this.nodes[y][x], new HashSet<>());
            }
        //connect nodes
        for (int y = 0; y < nodes.length; y++)
            for (int x = 0; x < this.nodes[0].length; x++) {
                ...
                if (x < this.nodes[0].length - 1) {
                    SimpleWeightedDirectedEdge<GridNode> newEdge = new SimpleWeightedDirectedEdge<>(this.nodes[y][x], this.nodes[y][x + 1], this.nodes[y][x + 1].getWeight());
                    ...
                    newEdge = new SimpleWeightedDirectedEdge<>(this.nodes[y][x + 1], this.nodes[y][x], this.nodes[y][x].getWeight());
                    this.edges.add(newEdge);
                ...
                if (y < nodes.length - 1) {
                    SimpleWeightedDirectedEdge<GridNode> newEdge = new SimpleWeightedDirectedEdge<>(this.nodes[y][x], this.nodes[y + 1][x], this.nodes[y + 1][x].getWeight());
                    this.edges.add(newEdge);
                    this.outNeighborEdges.get(this.nodes[y][x]).add(newEdge);
                    ...
                    newEdge = new SimpleWeightedDirectedEdge<>(this.nodes[y + 1][x], this.nodes[y][x], this.nodes[y][x].getWeight());
                    this.edges.add(newEdge);
                    this.inNeighborEdges.get(this.nodes[y][x]).add(newEdge);
    ...
    public Set<WeightedDirectedEdge<GridNode>> getAdjacentEdges(final GridNode node) {
        final Set<WeightedDirectedEdge<GridNode>> newEdges = new HashSet<>(this.inNeighborEdges.get(node));
    ...
    public Set<WeightedDirectedEdge<GridNode>> getTraversableEdges(final GridNode node) {
        final Set<WeightedDirectedEdge<GridNode>> newEdges = new HashSet<>(this.outNeighborEdges.get(node));
        return Collections.unmodifiableSet(newEdges);
    }
    ...
    public List<GridNode> getAdjacentNodes(final GridNode node) {
        final ArrayList<GridNode> newNeighbors = new ArrayList<>(this.inNeighborNodes.get(node));
    ...
    public List<GridNode> getTraversableNodes(final GridNode node) {
        final ArrayList<GridNode> newNeighbors = new ArrayList<>(this.outNeighborNodes.get(node));
        return Collections.unmodifiableList(newNeighbors);
    }
}
