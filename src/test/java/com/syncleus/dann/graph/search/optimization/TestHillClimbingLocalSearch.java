...
public class TestHillClimbingLocalSearch {
    ...
    public void testEasyHill() {
        ...
        final HillClimbingLocalSearch<Grid, GridNode> searcher = new HillClimbingLocalSearch<>(easyHillGrid);
        ...
        Assert.assertEquals("incorrect solution found!", obtainedSolutionNode, expectedSolutionNode);
    }
}
