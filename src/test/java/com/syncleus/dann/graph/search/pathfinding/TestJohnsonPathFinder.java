...
import com.syncleus.dann.graph.search.WeightedDirectedGrid;
...
public class TestJohnsonPathFinder {
    ...
    private static boolean checkSolution(final GridNode start, final List<WeightedDirectedEdge<GridNode>> path, final int[][] solution) {
        int solutionIndex = 0;
    ...
    public void testHardGrid() {
        ...
        final JohnsonPathFinder<GridNode, WeightedDirectedEdge<GridNode>> pathFinder = new JohnsonPathFinder<>(hardGrid);
    ...
    public void testInfinityGrid() {
        ...
        final JohnsonPathFinder<GridNode, WeightedDirectedEdge<GridNode>> pathFinder = new JohnsonPathFinder<>(infinityGrid);
