...
public class TestBellmanFordPathFinder {
    ...
    public void testHardGrid() {
        ...
        final BellmanFordPathFinder<GridNode, DirectedEdge<GridNode>> pathFinder = new BellmanFordPathFinder<>(hardGrid);
    ...
    public void testInfinityGrid() {
        ...
        final BellmanFordPathFinder<GridNode, DirectedEdge<GridNode>> pathFinder = new BellmanFordPathFinder<>(infinityGrid);
