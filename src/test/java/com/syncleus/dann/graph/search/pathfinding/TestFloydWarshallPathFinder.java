...
public class TestFloydWarshallPathFinder {
    ...
    public void testHardGrid() {
        ...
        final FloydWarshallPathFinder<GridNode, DirectedEdge<GridNode>> pathFinder = new FloydWarshallPathFinder<>(hardGrid);
    ...
    public void testInfinityGrid() {
        ...
        final FloydWarshallPathFinder<GridNode, DirectedEdge<GridNode>> pathFinder = new FloydWarshallPathFinder<>(infinityGrid);
