...
public class TestDijkstraPathFinder {
    ...
    public void testHardGrid() {
        ...
        final DijkstraPathFinder<GridNode, BidirectedEdge<GridNode>> pathFinder = new DijkstraPathFinder<>(hardGrid);
    ...
    public void testInfinityGrid() {
        ...
        final DijkstraPathFinder<GridNode, BidirectedEdge<GridNode>> pathFinder = new DijkstraPathFinder<>(infinityGrid);
