...
public class TestSimpleBooleanField {
    ...
    public void testTwoState50() {
        final SimpleBooleanNetwork<TwoState> n = new SimpleBooleanNetwork<>(TwoState.B);
    ...
    public void testThreeStateBalanced() {
        final SimpleBooleanNetwork<ThreeState> n = new SimpleBooleanNetwork<>(ThreeState.A);
    ...
    public void testFeverState() {
        ...
        final SimpleBooleanNetwork<FeverState> n = new SimpleBooleanNetwork<>(FeverState.HOT);
    ...
    private static class SimpleBooleanNetwork<I> extends MutableMarkovRandomFieldAdjacencyGraph<GraphicalModelNode, UndirectedEdge<GraphicalModelNode>> {
        ...
        public SimpleBooleanNetwork(final I initialState) {
            ...
            this.goal = new SimpleGraphicalModelNode<>(BooleanState.FALSE);
            ...
            add(this.goal);
            //connect nodes
            final UndirectedEdge<GraphicalModelNode> testEdge = new ImmutableUndirectedEdge<>(this.influence, this.goal);
            this.add(testEdge);
            goals.add(this.goal);
