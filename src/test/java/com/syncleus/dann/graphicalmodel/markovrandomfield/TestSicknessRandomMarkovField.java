...
public class TestSicknessRandomMarkovField {
    ...
    //create nodes
    private GraphicalModelNode<SeasonState> season = new SimpleGraphicalModelNode<>(SeasonState.WINTER);
    private GraphicalModelNode<AgeState> age = new SimpleGraphicalModelNode<>(AgeState.BABY);
    private GraphicalModelNode<BooleanState> stuffyNose = new SimpleGraphicalModelNode<>(BooleanState.TRUE);
    private GraphicalModelNode<FeverState> fever = new SimpleGraphicalModelNode<>(FeverState.HOT);
    private GraphicalModelNode<BooleanState> tired = new SimpleGraphicalModelNode<>(BooleanState.FALSE);
    private GraphicalModelNode<BooleanState> sick = new SimpleGraphicalModelNode<>(BooleanState.FALSE);
    ...
    public void testOverallRepeated() {
        for (int i = 0; i < 10; i++) {
            ...
            this.season = new SimpleGraphicalModelNode<>(SeasonState.WINTER);
            this.age = new SimpleGraphicalModelNode<>(AgeState.BABY);
            this.stuffyNose = new SimpleGraphicalModelNode<>(BooleanState.TRUE);
            this.fever = new SimpleGraphicalModelNode<>(FeverState.HOT);
            this.tired = new SimpleGraphicalModelNode<>(BooleanState.FALSE);
            this.sick = new SimpleGraphicalModelNode<>(BooleanState.FALSE);
        }
    }
