...
public class TestByteValueGene {
    ...
    public void testConstructors() {
        ...
        Assert.assertEquals("value constructor failed", test.getValue().getNumber().byteValue(), (byte) 123);
        test = new ByteValueGene(new MutableByte((byte) 57));
        Assert.assertEquals("MutableByte value constructor failed", test.getValue().getNumber().byteValue(), (byte) 57);
        test = new ByteValueGene((byte) 83);
        Assert.assertEquals("Number value constructor failed", test.getValue().getNumber().byteValue(), (byte) 83);
        test = new ByteValueGene();
        Assert.assertEquals("default constructor failed", test.getValue().getNumber().byteValue(), (byte) 0);
    }
