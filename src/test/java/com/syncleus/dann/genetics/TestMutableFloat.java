...
public class TestMutableFloat {
    ...
    public void testConstructors() {
        ...
        Assert.assertTrue("value constructor failed", Math.abs(test.getNumber() - 123f) < 0.000001f);
        test = new MutableFloat("456");
        Assert.assertTrue("string value constructor failed", Math.abs(test.getNumber() - 456f) < 0.000001f);
        test = new MutableFloat(789f);
        Assert.assertTrue("Number value constructor failed", Math.abs(test.getNumber() - 789f) < 0.000001f);
    }
