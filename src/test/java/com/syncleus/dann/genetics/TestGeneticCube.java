...
public class TestGeneticCube {
    ...
    private static class VolumeAreaCubeFitness extends AbstractGeneticAlgorithmFitnessFunction {
        ...
        public int compareTo(final AbstractGeneticAlgorithmFitnessFunction baseCompareWith) {
            ...
            return Double.compare(compareWith.getError(), this.getError());
        }
    }

    private static class VolumeAreaCubePopulation extends AbstractGeneticAlgorithmPopulation {
