...
public class TestMutableShort {
    ...
    public void testConstructors() {
        ...
        Assert.assertEquals("value constructor failed", (short) test.getNumber(), 123);
        test = new MutableShort("456");
        Assert.assertEquals("string value constructor failed", (short) test.getNumber(), 456);
        test = new MutableShort((short) 789);
        Assert.assertEquals("Number value constructor failed", (short) test.getNumber(), 789);
    }
