...
public class TestMutableInteger {
    ...
    public void testConstructors() {
        ...
        Assert.assertEquals("value constructor failed", 123, (int) test.getNumber());
        test = new MutableInteger("456");
        Assert.assertEquals("string value constructor failed", 456, (int) test.getNumber());
        test = new MutableInteger(789);
        Assert.assertEquals("Number value constructor failed", 789, (int) test.getNumber());
    }
