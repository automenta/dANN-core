...
public class TestMagicSquare {
    ...
    public void testMagicSquare() {
        ...
        for (int n = 3; n <= 32; n++) {
            ...
            final LuDecomposition<RealMatrix, RealNumber> LU = new DoolittleLuDecomposition<>(currentMatrix);
            ...
            final QrDecomposition<RealMatrix, RealNumber> QR = new HouseholderQrDecomposition<>(currentMatrix);
