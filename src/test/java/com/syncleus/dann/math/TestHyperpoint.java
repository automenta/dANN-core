...
public class TestHyperpoint {
    ...
    public void testAccessors() {
        ...
        Assert.assertEquals("dimensions value is incorrect", 3, testPoint.getDimensions());
        final Vector anotherTestPoint = new Vector(testPoint);
        Assert.assertEquals("dimensions value is incorrect", 3, anotherTestPoint.getDimensions());
    ...
    public void testToString() {
        ...
        Assert.assertEquals(testPoint.toString() + " != {1.0,2.0,3.0}", 0, testPoint.toString().compareToIgnoreCase("{1.0,2.0,3.0}"));
    }
}
