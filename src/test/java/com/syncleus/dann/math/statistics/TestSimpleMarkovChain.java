...
*/
        ...
        final Set<WeatherState> states = EnumSet.noneOf(WeatherState.class);
        states.add(WeatherState.SUNNY);
        states.add(WeatherState.RAINY);

        final MarkovChain<WeatherState> simpleChain = new SimpleMarkovChain<>(transitionProbabilities, states);
...
*/
        ...
        final MarkovChain<WeatherState> simpleChain = new SimpleMarkovChain<>(transitionProbabilities, 2, states);
        simpleChain.transition(WeatherState.SUNNY);
    ...
    public void testSampledChainFirstOrder() {
        final MarkovChainEvidence<WeatherState> chainEvidence = new SimpleMarkovChainEvidence<>(true, 1);
    ...
    public void testSampledChainSecondOrder() {
        final MarkovChainEvidence<WeatherState> chainEvidence = new SimpleMarkovChainEvidence<>(true, 2);
        //determine initial state
        WeatherState lastState;
        if (RANDOM.nextBoolean())
            lastState = WeatherState.SUNNY;
