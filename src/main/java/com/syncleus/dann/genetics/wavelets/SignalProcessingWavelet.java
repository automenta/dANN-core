...
public class SignalProcessingWavelet implements Comparable<SignalProcessingWavelet>, Cloneable {
    ...
    @Deprecated private static final Random RANDOM = new Random();
    // </editor-fold>
    ...
    private Set<SignalConcentration> signals = new HashSet<>();
    private List<WaveMultidimensionalFunction> waves = new ArrayList<>();
    ...
    public SortedSet<SignalConcentration> getSignals() {
        final SortedSet<SignalConcentration> copy = new TreeSet<>(this.signals);
    ...
    public SignalProcessingWavelet clone() {
        try {
            ...
            copy.signals = new TreeSet<>(this.signals);
            final List<WaveMultidimensionalFunction> newWaves = new ArrayList<>();
    ...
    public abstract static class SignalConcentration implements Comparable<SignalConcentration> {
        ...
        public int compareTo(final SignalConcentration compareWith) {
            return (Long.compare(this.id, compareWith.id));
        }
        ...
        public boolean equals(final Object compareWith) {
            return this == compareWith ||
                    (compareWith instanceof SignalConcentration && ((SignalConcentration) compareWith).id == this.id);
        }
    }
