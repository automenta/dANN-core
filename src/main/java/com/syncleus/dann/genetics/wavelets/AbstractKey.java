...
public abstract class AbstractKey implements Cloneable {
    ...
    protected AbstractKey() {
        this.points = Map.of(RANDOM.nextInt(), RANDOM.nextBoolean());
    }
    ...
    protected AbstractKey(final Map<Integer, Boolean> ourPoints) {
        ...
        this.points = Map.copyOf(ourPoints);
    }
    ...
    public String toString() {
        final SortedSet<Integer> orderedIndexes = new TreeSet<>(this.points.keySet());
    ...
    public AbstractKey mutate(final double deviation) {
        ...
        final Integer[] pointsArray = new Integer[n];
