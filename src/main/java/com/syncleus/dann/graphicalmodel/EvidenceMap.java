...
public class EvidenceMap<S> extends HashMap<Map<GraphicalModelNode, Object>, StateEvidence<S>> {
    ...
    public EvidenceMap(final Set<GraphicalModelNode> influencingNodes) {
        this.influencingNodes = Set.copyOf(influencingNodes);
    }

    public EvidenceMap(final GraphicalModelNode influencingNode) {
        this.influencingNodes = Set.of(influencingNode);
    }
