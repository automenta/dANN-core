...
public class SimpleGraphicalModelNode<S /* implements Comparable<?>*/> extends AbstractContextNode<GraphicalModelNode<S>, BidirectedEdge<GraphicalModelNode<S>>, GraphicalModel<GraphicalModelNode<S>, BidirectedEdge<GraphicalModelNode<S>>>> implements GraphicalModelNode<S> {
    ...
    public SimpleGraphicalModelNode(final S initialState) {
        ...
        this.learnedStates = new TreeSet<>();
    }
    ...
    public double stateProbability(Set<? extends GraphicalModelNode> ignoredInfluences) {
        final Set<GraphicalModelNode> influences = new HashSet<>(this.getInfluencingNodes());
        ...
        return ((double) evidenceOccurrence) / totalOccurrence;
    }
    ...
    private Map<GraphicalModelNode, Object> getInfluencingStates() {
        ...
        final Map<GraphicalModelNode, Object> inStates = new HashMap<>();
        ...
        for (final BidirectedEdge<GraphicalModelNode<S>> inEdge : inEdges) {
            ...
            List<GraphicalModelNode<S>> otherNodes = new ArrayList<>(inEdge.getNodes());
    ...
    protected Set<GraphicalModelNode> getInfluencingNodes() {
        ...
        final Set<BidirectedEdge<GraphicalModelNode<S>>> inEdges = this.getJoinedGraphs().iterator().next().getAdjacentEdges(this);
        final Set<GraphicalModelNode> inNodes = new HashSet<>();
        for (final BidirectedEdge<GraphicalModelNode<S>> inEdge : inEdges) {
            //if it is traversable to this node it is an influence
            List<GraphicalModelNode<S>> otherNodes = new ArrayList<>(inEdge.getNodes());
            otherNodes.remove(this);
