...
public class NeuronGroup<N extends Neuron> implements java.io.Serializable {
     ...
     */
    public NeuronGroup() {
        this.childrenNeurons = new HashSet<>();
        this.childrenNeuronGroups = new HashSet<>();
    }
    ...
    public NeuronGroup(final NeuronGroup<? extends N> copyGroup) {
        this.childrenNeurons = new HashSet<>(copyGroup.getChildrenNeurons());
        this.childrenNeuronGroups = new HashSet<>(copyGroup.getChildrenNeuronGroups());
    }
    ...
    public Set<N> getChildrenNeuronsRecursivly() {
        ...
        final HashSet<N> returnList = new HashSet<>(this.childrenNeurons);
