        ...
        return
                (
                        (compareTo.getLeftNode().equals(this.getLeftNode()))
                                ...
                                && (compareTo.getLeftEndState() == this.getLeftEndState())
                                && (compareTo.getRightEndState() == this.getRightEndState())
                )
                        || (
                        (compareTo.getLeftNode().equals(this.getRightNode()))
                                && (compareTo.getRightNode().equals(this.getLeftNode()))
                                && (compareTo.getLeftEndState() == this.getRightEndState())
                                && (compareTo.getRightEndState() == this.getLeftEndState())
                );
    }
