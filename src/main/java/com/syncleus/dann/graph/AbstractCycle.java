...
public abstract class AbstractCycle<N, E extends TraversableCloud<N>> extends AbstractWalk<N, E> implements Cycle<N, E> {
    static <N, E extends TraversableCloud<? extends N>> boolean verifyUtility(final List<N> nodeSteps, final List<E> edgeSteps) {
        if (nodeSteps.size() < 2)
