...
public abstract class AbstractWalk<N, E extends TraversableCloud<N>> implements Walk<N, E> {
    ...
    public boolean isTrail() {
        final Set<E> edgeSet = new HashSet<>(this.getSteps());
    ...
    public boolean hasChildCycles() {
        final Graph<N, E> graph = new ImmutableAdjacencyGraph<>(new HashSet<>(this.getNodeSteps()), new HashSet<>(this.getSteps()));
        final CycleFinder<N, E> finder = new ExhaustiveDepthFirstSearchCycleFinder<>();
        if (this.isCycle()) {
    ...
    @Override
    public int hashCode() {
        final Set<N> uniqueNodes = new HashSet<>(this.getNodeSteps());
        final Set<E> uniqueEdges = new HashSet<>(this.getSteps());
    ...
    public boolean equals(final Object object) {
        ...
        final Set uniqueNodes = new HashSet<>(this.getNodeSteps());
        final Set uniqueEdges = new HashSet<>(this.getSteps());
